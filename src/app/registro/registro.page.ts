...
export class RegistroPage {
  ...
  nombreUser: any;
  emailUser: any;
  datosUser: Administrador;
  private todo: FormGroup;
  data: any;
  distribuidoras: any = [];
  distribuidoraEmail: any;
  textoBuscar = '';
  distribuidora: any = '';
  constructor(
  ...
  async onRegister() {
    ...
    if (user) {
      ...
      this.data = {
          ...
          distribuidora_email: this.distribuidoraEmail,
  ...
  segmentChanged(event) {
    ...
    this.distribuidoras.forEach(element => {
      if (element.distribuidora === this.distribuidora) {
        this.distribuidoraEmail = element.email;
        console.log(this.distribuidoraEmail);
      }
 });
  }
  searchLocal(event) {
